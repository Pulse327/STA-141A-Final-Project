...
auroc
```
The AUROC value is 0.6912, which means that a randomly chosen positive example (case) has 69.12% of chance to be ranked higher by the our model than a randomly chosen negative example (control).
...
The model shows good accuracy and precision but has room for improvement in recall, indicating it sometimes misses actual positives. Specificity is modest, suggesting the model's performance in identifying negatives could be enhanced.
